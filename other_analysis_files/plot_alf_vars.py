...
colors = ['lightcoral', 'chocolate', 'peru', 'darkorange', 'goldenrod', 'gold', 'khaki', 'lawngreen', 
        'limegreen', 'lime', 'turquoise', 'teal', 'red', 'royalblue', 'crimson']
...
for var in np.arange(start, end, 1):
    ...
    j = int(var - start)
    plt.plot(win, free_energy_curve, label=f'iteration{var}', linestyle='--', color=f'{colors[j]}')
